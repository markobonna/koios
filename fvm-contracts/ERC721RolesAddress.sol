...
contract ERC721RolesAddress {
    ...
    function removeFrom725StoreList(address _allowedAddress) public {
        if (
            ...
            revert(
                "ERC721RolesAddress: Not enough permissions to remove from 725StoreList"
            );
        }
    }
    ...
    function removeFromCreateERC20List(address _allowedAddress) public {
        if (
            ...
            emit RemovedFromCreateERC20List(
                _allowedAddress,
                msg.sender,
                block.timestamp,
                block.number
            ...
            revert(
                "ERC721RolesAddress: Not enough permissions to remove from ERC20List"
            );
        }
    }
    ...
    function removeFromMetadataList(address _allowedAddress) public {
        if (
            ...
            revert(
                "ERC721RolesAddress: Not enough permissions to remove from metadata list"
            );
        }
    }
     ...
     */
    function addMultipleUsersToRoles(
        address[] memory addresses,
        RolesType[] memory roles
